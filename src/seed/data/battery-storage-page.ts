export const batteryStorageSections = [
  {
    ...
    title: "Perth Climate",
    description:
      "WA's #1 Rated Solar Installer With 45,000+ Installations Since 2003. CEC-Approved. ProductReview Award Winner 2021–2026.",
...

  {
    ...
    bottomSubtitle:
      "Across our 45,000+ installations, Perth households combining solar with battery storage typically see bill reductions of 70–90% — transforming electricity from a major expense into a near-negligible one.",
    cards: [
      {
        title: "Maximize Your Solar",
        description:
          "Store excess daytime solar power for use at night, drastically reducing your reliance on the grid.",
      },
      {
        title: "Power Outage Protection",
        description:
          "Keep the lights on and the fridge running even when the grid goes down.",
      },
      {
        title: "Future-Proof Your Home",
        description:
          "Prepare for rising energy costs and the transition to electric vehicles with home battery storage.",
      },
    ],
  },

  {
    ...
    description:
      "A home battery stores the solar your panels produce during the day so you can use it after sundown, when grid electricity is most expensive.",
    cards: [
      {
        title: "Shift Your Usage",
        description:
          "Use stored solar energy during peak evening hours when electricity is most expensive.",
      },
      {
        title: "Achieve True Independence",
        description:
          "Many of our customers with appropriately sized solar and battery systems receive bills close to $0.",
      },
      {
        title: "Seamless Backup Power",
        description:
          "Keep your most important appliances running effortlessly, even when the grid fails during a storm.",
      },
      {
        title: "Beat Rising Tariffs",
        description:
          "Lock in your energy costs today and protect your household from future electricity price hikes.",
      },
      {
        title: "Maximize Your Investment",
        description:
          "Store every drop of excess solar your panels generate, rather than sending it back for pennies.",
      },
    ],
  },
    ...
    batteries: [
      {
        ...
        description:
          "App control, VPP integration, automated load shifting and EV-ready. The next generation of what a home battery can do.",
      ...
      },
      {
        ...
        description:
          "Tesla Powerwall 3, BYD, Alpha ESS, Sigenergy, iStore and more. Right-sized for your home, your usage and your solar system.",
      ...
      },
      {
        ...
        description:
          "Step-by-step guide to the WA Residential Battery Scheme, federal Cheaper Home Batteries Program, and the $10,000 interest-free loan.",
      ...
      },
      {
        ...
        description:
          "Every brand we install is CEC-approved, on Synergy's Supported Solutions List, and field-tested in WA conditions.",
      ...
      },
      {
        ...
        description:
          "40+ questions from Perth homeowners — sizing, VPP, blackouts, warranties, real-world performance.",
...

  {
    ...
    description:
      "For most Perth homeowners, three incentives combine to take thousands off the price of a battery.",
    cards: [
      {
        title: "WA Residential Battery Scheme",
        description:
          "Up To $1,300 (Synergy) Or $3,800 (Horizon)",
      },
      {
      ...
      },
      {
        ...
        description:
          "Up To $10,000 Over 3–10 Years (Via Plenti, Income Under $210k)",
      },
    ],
    footerText:
      "Combined Value: Up To $5,000 (Synergy) Or $7,500 (Horizon) Off A 10kWh Battery. Plus The Option To Finance The Rest At 0% Interest.",
...

  {
    ...
    description:
      "It's not just about the hardware; it's about the lifestyle change.",
    cards: [
      {
        title: "Peace of Mind",
        description:
          "Never worry about the next electricity bill or sudden rate hikes.",
      },
      {
        title: "Backup When You Need It",
        description:
          "Keep essential appliances running during grid outages.",
      },
      {
        title: "Clean Energy Maximised",
        description:
          "Maximize your use of clean, renewable energy every day.",
      },
      {
        title: "Home Value Boost",
        description:
          "Increase the resale value and appeal of your property.",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        description:
          "Our team visits your property or runs a remote assessment. We review your energy bills, roof orientation, main switchboard capacity, and any existing solar.",
      },
      {
        title: "Custom System Design",
        description:
          "Our engineers design a tailored system based on your usage patterns, roof layout, and future plans like EV charging.",
      },
      {
        title: "Western Power Approval",
        description:
          "We handle the full application to Western Power and Synergy. You don't need to lift a finger.",
      },
      {
        title: "Installation Day",
        description:
          "Our in-house CEC-accredited electricians install your system in 1–2 days. No subcontractors.",
      },
    ],
  },
    ...
    cards: [
      {
        ...
        description:
          "One of the few Perth installers with direct Tesla Powerwall certification. We're trained and authorised by Tesla, not just retailing the product.",
      },
      {
        title: "NETCC Approved Retailer",
        description:
          "NETCC is the highest accreditation. Our compliance, installation standards and consumer protections are independently verified.",
      },
      {
        title: "ProductReview Award, 6 Years Running",
        description:
          "Winner 2021, 2022, 2023, 2024, 2025, 2026. Verified customer reviews, not marketing stats.",
      },
      {
        title: "45,000+ Solar | 3000+ Storage Installations",
        description:
          "From a single roof in Canning Vale to industrial-scale off-grid systems. Scale matters when warranty time comes around.",
      },
      {
        title: "Local, Since 2003",
        description:
          "Perth-based head office in Canning Vale. Same team that sells is the team that installs and services — 23 years later.",
      },
    ],
...

  {
    ...
    stories: [
      {
        quote:
          "Our bills went from $600 to essentially zero. The battery was the best investment we made.",
        author: "Sarah M.",
        location: "Joondalup, WA",
      },
      {
        quote:
          "The team at Regen Power were professional from start to finish. Highly recommend.",
        author: "David & Lisa T.",
        location: "Mandurah, WA",
      },
      {
        quote:
          "We love having backup power. When the grid went down last month, we didn't even notice.",
        author: "Mark W.",
    ...
    items: [
      {
        ...
        answer:
          "Most quality solar batteries come with a 10-year warranty and are expected to last 10-15 years depending on usage cycles.",
      },
      {
        question: "Can I add a battery to my existing solar system?",
        answer:
          "Yes, in most cases we can retrofit a battery. We call this AC coupling, and it works with almost any existing solar inverter.",
      },
      {
        question: "Do I still need to be connected to the grid?",
        answer:
          "While you can go completely off-grid, it's usually more cost-effective to remain grid-connected for backup during long periods of bad weather.",
      },
    ],
  },
