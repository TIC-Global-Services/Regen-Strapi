export const batteryBrandsSections = [
  {
    ...
    subtitle: "Home / Battery / Brands We Carry",
    ...
    cards: [
      {
        ...
        description:
          "35+ Solar Companies In WA Have Closed In The Last 3 Years Alone. When The Installer Went, So Did Their Warranties. We Only Install Brands With Genuine Global Scale And Australian Distribution Partners.",
      },
      {
        title: "The Chemistry You Want Is LFP",
        description:
          "Lithium Iron Phosphate Runs Cooler, Tolerates Perth's Heat Better Than Older NMC Chemistry, And Has A Fundamentally Lower Thermal Runaway Risk. Every Brand We Install Uses LFP Exclusively.",
      },
      {
        title: "Ecosystem Lock-In Is Real",
        description:
          "For Better Or Worse, Some Brands Work With Everything (BYD). Others Build An Ecosystem Around Themselves (Tesla, Sigenergy) With Benefits If You Buy In Fully, Less Benefit If You Mix. Know What You're Choosing.",
      },
    ],
  },

  {
    ...
    description:
      "Brands we have specifically chosen not to install (for reference): older NMC chemistry products, single-source imports without Australian distribution, brands without genuine VPP compatibility, batteries under 5 kWh (too small to clear WA rebate minimum).",
    items: [
      "CEC Approved Battery List — included and current",
      "Synergy or Horizon Power Supported Solutions List — qualified for WA Residential Battery Scheme",
      "LFP chemistry — safer, longer-lasting, better in WA heat",
      "Australian distribution presence — warranty support that survives the retailer",
      "Verifiable field performance — either through our own install base or through independent industry review",
    ],
  },
...

  {
    ...
    rows: [
      {
        label: "Efficiency",
        values: ["22.3%", "22.8%", "22.5%", "22.4%", "22.0%"],
      },
      {
        label: "Temp Coeff",
        values: ["-0.29%/°C", "-0.26%/°C", "-0.28%/°C", "-0.30%/°C", "-0.30%/°C"],
      },
      {
        label: "Degradation",
        values: ["0.40%/yr", "0.35%/yr", "0.40%/yr", "0.40%/yr", "0.40%/yr"],
      },
      {
        label: "Warranty",
        values: ["25 yr product · 30 yr performance", "25 yr product · 30 yr performance", "25 yr product · 30 yr performance", "25 yr product · 30 yr performance", "25 yr product · 30 yr performance"],
      },
    ],
  },
    ...
    cards: [
      {
        ...
        description:
          "When We Quote A Battery, It Will Be On Both Lists. If You're Researching A Brand Not On Our Page, Check Both Lists Before Committing. Scheme Eligibility Hinges On It.",
      },
      {
        title: "CEC Approved Battery List",
        description:
          "Maintained By The Clean Energy Council. A Battery Must Be CEC-Approved To Be Installed By A CEC-Accredited Installer, Which Is A Prerequisite For The Federal Cheaper Home Batteries Program Rebate. All 7 Brands On This Page Are CEC-Approved.",
      },
      {
        title: "Synergy / Horizon Power Supported Solutions List",
        description:
          "Maintained By The WA Electricity Retailers. A Battery Must Appear On The SSL (For Your Retailer) To Qualify For The WA Residential Battery Scheme Rebate. All 7 Brands On This Page Are On The Relevant SSL — But Specific Models Vary, So We Confirm The Exact Product Eligibility At Quote Stage.",
      },
      {
        title: "Why The Two Lists Aren't Identical",
        description:
          "CEC Approval Is A Safety And Performance Standard. SSL Inclusion Adds WA-Specific Requirements Around VPP Compatibility, Data Protocol And Network Integration. A Battery Can Be CEC-Approved But Not On A WA SSL — Common For Newer Brands Still Working Through State Qualification.",
      },
    ],
  },

  {
    ...
    subtitle:
      "Installing These Brands Well Isn't Plug-And-Play. Several Of Them Require Installer Certifications Beyond General CEC Accreditation. Here's What We Hold:",
    certifications: [
    ...
    whyMattersDescription:
      "When A Brand Audits An Installer's Work, Uncertified Installs Can Void The Manufacturer Warranty. Every Install We Do Is Performed By An Installer Holding The Relevant Brand Certifications — Protecting Your Warranty On Day One And Every Day After.",
  },
    ...
    items: [
      {
        ...
        answer:
          "Most modern home batteries are designed to last between 10 and 15 years. They typically come with a 10-year manufacturer warranty guaranteeing about 70-80% of their initial capacity after a decade of daily usage.",
      },
      {
        question: "What is Depth of Discharge (DoD)?",
        answer:
          "Depth of Discharge refers to the percentage of the battery's capacity that can be safely used without damaging the cells. High-quality LFP batteries like Tesla and iStore support 100% DoD, meaning you can use their full capacity.",
      },
      {
        question: "Which battery brand is best for going off-grid?",
        answer:
          "For off-grid applications, modular batteries with high-peak output capabilities like BYD Premium, or heavy-duty systems like Sigenergy SigenStor, are highly recommended because they allow you to customize capacity and handle large surge currents.",
      },
      {
        question: "Are there government rebates available for battery installation in Perth?",
        answer:
          "Yes. Western Australian residents can stack federal incentives (Cheaper Home Batteries Program) with state-level rebates (WA Residential Battery Scheme) for a combined saving of up to $7,500 on a 10 kWh battery.",
      },
      {
        question: "How do I choose the right battery capacity for my home?",
        answer:
          "The right size depends on your household energy consumption overnight and your solar generation. A standard 4-person household in Perth usually finds a capacity of 10 kWh to 13.5 kWh provides the best balance of cost and utility.",
      },
    ],
  },

  {
    ...
    description:
      "Tell us which brand you're leaning towards (or we'll help you choose) and we'll put together a personalised quote with your rebate already applied.",
